...
async function failCommand(id, error) {
	...
	// Also on our own stderr: the broker currently keeps agent_error out of the
	// tool result, and a silent 'lost' with no output is the hardest possible
	// thing to diagnose from the client side.
